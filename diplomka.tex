...
\end{itemize}
\vspace{-5pt}
%TODO mention that $\mathcal{A}[h](last(h)) = f(r(f))$ ?
We define $\sigma_\epsilon^{reg}(h) = f(r(f))$ where $f$ is the state of $\mathcal{A}$ reached after reading the history $h$.
