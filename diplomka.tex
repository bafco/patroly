...
When it comes to solving the game, some form of equilibrium strategy profile is in demand. The best known solution concept in game theory is \emph{Nash equilibrium}, in which no player can gain anything by changing only his strategy. That is, each player's strategy is a best response to the other players' strategies.

Different solution concepts were designed for specific game models. We are specially interested in Strong Stackelberg Equilibrium, which we describe in the next section.

\section{Security Games}

% The standard solution concept for Stackelberg games is Strong Stackelberg Equilibrium (SSE).
Another solution concept, which is of great importance in security games, is \emph{Strong Stackelberg Equilibrium} (SSE, also \emph{leader-follower equilibrium}).
