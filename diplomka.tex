...
Further, the values for $k = 1$ represent the probability distribution over the nodes in the next step, i.e. $\mathbf{Char}_p(1, u) = \xi(p)(u)$.
That is because $\mathbf{Char}_{\delta(p, v)}(0, u) = 0$ for all $v \neq u$.
