...
\end{itemize}
\vspace{-5pt}
This unique node $u$ is called the \emph{root} of the characteristic $c$.% and is denoted by $r(c)$. %TODO funkcia $r$ by bola polymorfna
...
c(k, u)
  ...
  &= c(1, u) + \sum_{i = 1, u_i \neq u}^n c(1, u_i) \cdot \mathbf{Char}_{\delta_{Char}(c, u_i)}(k - 1, u)\nonumber \\ %%%f
  &= c(1, u) + \sum_{v \neq u} c(1, v) \cdot \mathbf{Char}_{\delta_{Char}(c, v)}(k - 1, u)\nonumber \\ % from the definition of characteristic of a state
