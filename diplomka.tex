...
A \emph{strategic form game} (or simply a \emph{game}) is played between \emph{players} $P_1, \dots, P_n, n \geq 2$.
...
We see that the behaviour of the strategy in the first two steps (for histories of length $0$ and $1$) is encoded by the initial state $q_0$.
...
Note that these two properties can be represented by a $1$-commitment.
