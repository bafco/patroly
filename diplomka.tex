...
\vspace{-5pt}
\caption{{Graph settings for examples of multi-robot patrolling games.}}
\label{fig:examples2}
\end{figure}

\begin{example}
\label{ex:centralized}
Consider an MRPG played on the graph from Fig.~\ref{fig:examples2} (left), where all nodes are targets.
\end{example}
