...
%\noindent
%\textit{Remark 1. }
%When a play in is a state $p \in Q_{Char}$, there is exactly one unique $d$-commitment $f$ (determined by $\sigma_{Char}$) which represents the current $d$-step randomized plan for the defender.
...
When a play in is any state, there is exactly one unique $d$-commitment which represents the current $d$-step randomized plan for the defender.
