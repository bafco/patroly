...
\end{align}
\begin{itemize}[noitemsep]
	\item To prove the first inequality, we have to analyze the impact of the rounding in the definition of $\sigma_\epsilon$.
...
$$|\sigma(h)(u) - \sigma_\epsilon(h)(u)| < t~.$$
We prove by induction that
\begin{align}
| R[\sigma_h, last(h), t, k] - R[{\sigma_\epsilon}_h, last(h), t, k]| \leq k|U|t\label{eq:induction}
\end{align}
and therefore
$$| att\text{-}val(\sigma_\epsilon \mid h) - att\text{-}val(\sigma \mid h) \leq d|U|t \leq \epsilon~.$$

%TODO To prove \eqref{eq:induction}
