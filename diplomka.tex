...
The Stackelberg setting forces the attacker to play the best response to the defender's strategy.
...
optimal strategy = optimal defender's strategy

example -  the defender does not know whether an attack has already started
