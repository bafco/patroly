...
%Note that inevitably $\mathbf{Char}_p(k, u) \leq \mathbf{Char}_p(k + 1, u)$ except for the case when $k = 0$ and $\mathbf{Char}_p(k, u) = 1$.
%TODO zmienit, ze Char(0, _) sluzi LEN na urcenie aktualnej polohy defendera, ze to ide aj bez nej (a ze do "at most k steps" nezaratavame tuto pravdepodobnost)
