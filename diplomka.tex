...
and by $\mathcal{H}_0 = \mathcal{H} \cup \{\epsilon\}$ the set of all histories.
...
For a given defender's strategy $\sigma$, we denote by $\mathcal{H}_0(\sigma)$ the set of all relevant histories and we put $\mathcal{H}(\sigma) = \mathcal{H}_0(\sigma) \smallsetminus \{\epsilon\}$.
...
\begin{definition}
Let $\sigma \in \Sigma$ be a defender's strategy and $h \in \mathcal{H}_0$ a history. %TODO $h \in \mathcal{H}_0$ ???
