...
And as the value of the strategy is at most $\inf_{t\in T} p(t)$, which is at most $\sum_{t \in T}p(t) / |T| = 2/3$, we have an upper bound $2/3$ on the value of the game.
